...
namespace Testify_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new TestifyPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(Leem.Testify.GuidList.guidTestifyCmdSet, (int)Leem.Testify.PkgCmdIDList.cmdidSolutionTests);
