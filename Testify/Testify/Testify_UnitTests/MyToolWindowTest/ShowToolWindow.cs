...
namespace Testify_UnitTests.MyToolWindowTest
{
    [TestClass()]
    public class ShowToolWindowTest
    {
        ...
        public void ValidateToolWindowShown()
        {
            ...
            MethodInfo method = typeof(TestifyPackage).GetMethod("ShowToolWindow", BindingFlags.NonPublic | BindingFlags.Instance);
