...
namespace Testify_IntegrationTests
{
    ...
    public class MenuItemTest
    {
        ...
        public void LaunchCommand()
        {
            ...
            {
                CommandID menuItemCmd = new CommandID(Leem.Testify.GuidList.guidTestifyCmdSet, (int)Leem.Testify.PkgCmdIDList.cmdidSolutionTests);

                // Create the DialogBoxListener Thread.
                string expectedDialogBoxText = string.Format(CultureInfo.CurrentCulture, "{0}\n\nInside {1}.MenuItemCallback()", "Testify", "Leem.Testify.TestifyPackage");
