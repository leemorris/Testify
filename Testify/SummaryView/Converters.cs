...
namespace Leem.Testify.SummaryView
{
    ...
    public class MultiValueConverter : IMultiValueConverter
    {
        ...
        {
            decimal? sequenceCoverage = values[0] as Nullable<decimal>;
            decimal? branchCoverage = values[1] as Nullable<decimal>;
            DependencyProperty radioButton = values[2] as DependencyProperty;
            //if (!string.IsNullOrEmpty(sequenceCoverage) && !string.IsNullOrEmpty(two) && !string.IsNullOrEmpty(three))
            //{
